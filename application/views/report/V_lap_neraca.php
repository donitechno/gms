			...
			<div class="ui stackable menu" style="border-radius:0">
				<div class="item">
					<div class="ui breadcrumb">
						...
						<div class="active section">Laporan Neraca Harian</div>
					</div>
				</div>
			</div>
		</div>
		<form class="ui form form-javascript" id="form_transaction" action="<?php echo base_url() ?>index.php/C_lap_neraca/filter_lap" method="post">
		<div class="ui grid">
			...
			$.ajax({
				...
				success: function(response){
					if(response.success == true){
						document.getElementById("wrap_download").innerHTML = response.viewdownload;
						document.getElementById("wrap_filter_kanan").innerHTML = response.viewkanan;
						document.getElementById("wrap_filter_kiri").innerHTML = response.viewkiri;
