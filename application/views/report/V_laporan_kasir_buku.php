	...
	<div class="pusher">
		<div class="ui fluid container">
			...
			<div class="ui bottom attached tab segment active" data-tab="first">
				<form class="ui form" id="form_kas" action="<?php echo base_url() ?>index.php/C_lap_kasir_buku/filter_kas" method="post">
				<div class="ui grid">
			...
			<div class="ui bottom attached tab segment" data-tab="second">
				<form class="ui form" id="form_jual" action="<?php echo base_url() ?>index.php/C_lap_kasir_buku/filter_jual" method="post">
				<div class="ui grid">
					<div class="ten wide centered column" style="padding-bottom:0">
						<div class="fields">
							<div class="five wide field">
			...
			<div class="ui bottom attached tab segment" data-tab="third">
				<form class="ui form" id="form_beli" action="<?php echo base_url() ?>index.php/C_lap_kasir_buku/filter_beli" method="post">
				<div class="ui grid">
					<div class="ten wide centered column" style="padding-bottom:0">
						<div class="fields">
							<div class="five wide field">
...
<script>
	...
	function exeDeleteTransJual(idTrans){
		...
		$.ajax({
			url : webUrl+'/index.php/C_lap_kasir_buku/hapus_jual/'+idTrans,
			type: "GET",
			dataType: "JSON",
			success: function(response){
				if(response.success == true){
	...
	function exeDeleteTransBeli(idTrans){
		...
		$.ajax({
			url : webUrl+'/index.php/C_lap_kasir_buku/hapus_beli/'+idTrans,
			type: "GET",
			dataType: "JSON",
			success: function(response){
				if(response.success == true){
