			...
			<div class="ui stackable menu" style="border-radius:0">
				<div class="item">
					<div class="ui breadcrumb">
						...
						<div class="active section">Laporan Emas Pajangan</div>
					</div>
				</div>
			</div>
		</div>
		<form class="ui form form-javascript" id="form_transaction" action="<?php echo base_url() ?>index.php/C_lap_pajangan/filter_lap" method="post">
		<div class="ui grid">
