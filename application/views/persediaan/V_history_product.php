			...
			<div class="ui stackable menu no-print" style="border-radius:0">
				<div class="item">
					<div class="ui breadcrumb">
						...
						<div class="active section">History Product</div>
					</div>
				</div>
			</div>
			<div class="ui grid">
				<div class="fifteen wide centered column">
					<div class="ui grid">
						...
						<div class="sixteen wide centered column no-print">
							<form class="ui form form-javascript" id="form_transaction" action="<?php echo base_url() ?>index.php/C_history_product/execute" method="post">
							<div class="ui grid">
...
<script>
	...
	function cariTrans(){
		...
		if(productID != '_' && productID != ''){
			$.ajax({
				url : webUrl+'/index.php/C_history_product/get_product_from/'+productID,
				type: 'post',
