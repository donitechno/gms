...
<body onkeyup="entToAction()">
	<div class="ui container fluid">
		<div class="ui pointing secondary menu">
			<a class="item active" data-tab="first" style="width:33.3%" onclick=resetVal()>
			...
			*/ ?>
			<a class="item" data-tab="third" style="width:33.3%" onclick=ambilPesanan()>
				<i class="tags icon"></i> Ambil Pesanan
			</a>
			<a class="item" data-tab="fourth" style="width:33.3%" onclick=filterTrans()>
		...
		<div class="ui bottom attached tab segment active" data-tab="first">
			...
			<form  class="ui form form-javascript" id="form_transaction" action="<?php echo base_url() ?>index.php/C_pesanan_pos_bbcu/save" method="post">
			<div class="ui grid">
		...
		<div class="ui bottom attached tab segment" data-tab="second">
			...
			<form class="ui form form-javascript" id="form_box" action="<?php echo base_url() ?>index.php/C_pesanan_pos_bbcu/box/" method="post">
			<div class="ui grid">
		...
		<div class="ui bottom attached tab segment" data-tab="third">
			...
			<form class="ui form form-javascript" id="form_ambil" action="<?php echo base_url() ?>index.php/C_pesanan_pos_bbcu/ambil/" method="post">
			<div class="ui grid">
		...
		<div class="ui bottom attached tab segment" data-tab="fourth">
			...
			<form class="ui form form-javascript" id="form_filter" action="<?php echo base_url() ?>index.php/C_pesanan_pos_bbcu/filter/" method="post">
			<div class="ui grid">
					...
					<div class="fields">
						...
						<div class="four wide field">
							...
							<select name="filter_status" id="filter_status">
								...
								<?php /*<option value="B">Masuk Box</option> */ ?>
								<option value="C">Selesai</option>
								<?php /*<option value="X">Batal</option> */ ?>
							</select>
						</div>
...
<script>
	...
	function getMasterProduct(idRow){
		...
		if(categoryID != ''){
			$.ajax({
				url : webUrl+'/index.php/C_pesanan_pos_bbcu/get_master_product/'+categoryID+'/'+idRow,
				type: "GET",
				dataType: "JSON",
	...
	function getMasterProductModal(idRow){
		...
		if(categoryID != ''){
			$.ajax({
				url : webUrl+'/index.php/C_pesanan_pos_bbcu/get_master_product_modal/'+categoryID+'/'+idRow,
				type: "GET",
				dataType: "JSON",
				success: function(response){
					if(response.success == true){
	...
	function tambahBaris(){
		if(exeTambahBaris == false){
			...
			if(rowData == maxData){
				...
				$.ajax({
					url : webUrl+'/index.php/C_pesanan_pos_bbcu/tambah_baris/'+rowData,
					type: 'post',
					dataType: 'json',
					success: function(response){
						if(response.success == true){
	...
	function getCustomerForm(){
		...
		$.ajax({
			url : webUrl+'index.php/C_pesanan_pos_bbcu/get_customer_form/',
			type: "GET",
			dataType: "JSON",
			success: function(response){
				if(response.success == true){
	...
	function setCustomer(custPhone){
		...
		$.ajax({
			url : webUrl+'/index.php/C_pesanan_pos_bbcu/set_customer_form/'+custPhone,
			type: "GET",
			dataType: "JSON",
			success: function(response){
				if(response.success == true){
	...
	function getDetailPesanan(idPesanan){
		...
		$.ajax({
			url : webUrl+'/index.php/C_pesanan_pos_bbcu/get_detail_pesanan/'+idPesanan,
			type: "GET",
			dataType: "JSON",
			success: function(response){
				if(response.success == true){
	...
	function getDetailPesananBox(idPesanan){
		...
		$.ajax({
			url : webUrl+'/index.php/C_pesanan_pos_bbcu/get_detail_pesanan_box/'+idPesanan,
			type: "GET",
			dataType: "JSON",
			success: function(response){
				if(response.success == true){
	...
	function getDetailPesananAmbil(idPesanan){
		...
		$.ajax({
			url : webUrl+'/index.php/C_pesanan_pos_bbcu/get_detail_pesanan_ambil/'+idPesanan,
			type: "GET",
			dataType: "JSON",
			success: function(response){
				if(response.success == true){
	...
	function getEditPesanan(idPesanan){
		...
		$.ajax({
			url : webUrl+'/index.php/C_pesanan_pos_bbcu/get_edit_pesanan/'+idPesanan,
			type: "GET",
			dataType: "JSON",
			success: function(response){
				if(response.success == true){
	...
	function getTambahUMP(idPesanan){
		...
		$.ajax({
			url : webUrl+'/index.php/C_pesanan_pos_bbcu/get_tambah_ump/'+idPesanan,
			type: "GET",
			dataType: "JSON",
			success: function(response){
				if(response.success == true){
	...
	function getKurangUMP(idPesanan){
		...
		$.ajax({
			url : webUrl+'/index.php/C_pesanan_pos_bbcu/get_kurang_ump/'+idPesanan,
			type: "GET",
			dataType: "JSON",
			success: function(response){
				if(response.success == true){
	...
	function exeBatalPesanan(idPesanan){
		...
		$.ajax({
			url : webUrl+'/index.php/C_pesanan_pos_bbcu/batal_pesanan/'+idPesanan,
			type: "GET",
			dataType: "JSON",
			success: function(response){
				if(response.success == true){
	...
	function exeStepBackPesanan(idPesanan){
		...
		$.ajax({
			url : webUrl+'/index.php/C_pesanan_pos_bbcu/stepback_pesanan/'+idPesanan,
			type: "GET",
			dataType: "JSON",
			success: function(response){
				if(response.success == true){
	...
	function ambilPesananBBCU(idPesanan){
		var webUrl = "<?php echo base_url()?>";
		document.getElementById("myModal").className += " mini";
		
		$.ajax({
			url : webUrl+'/index.php/C_pesanan_pos_bbcu/get_ambil_pesanan_bbcu/'+idPesanan,
			type: "GET",
			dataType: "JSON",
			success: function(response){
				if(response.success == true){
					...
					$(function(){
						$( "#ambil_date_bbcu" ).datepicker({
							dateFormat: 'dd MM yy'
						});
						
						$('#ambil_date_bbcu').datepicker('setDate', 'today');
					});
	...
	function saveAmbilPesananBBCU(){
		if(exeTrans == false){
			exeTrans = true;
			
			document.getElementById("error_modal").setAttribute('style','display:none');
			document.getElementById("btn_save_ambil_bbcu").className += " loading";
			
			$.ajax({
				url: $('#form_ambil_pesanan_bbcu').attr('action'),
				type: 'post',
				data: $('#form_ambil_pesanan_bbcu').serialize(),
				dataType: 'json',
				success: function(response){
					if(response.success == true){
						document.getElementById("myModal").innerHTML = "";
						...
						exeTrans = false;
						document.getElementById("btn_save_ambil_bbcu").classList.remove("loading");
					}
				},
				error: function (jqXHR, textStatus, errorThrown){
					alert('Error get data from ajax');
