	...
	<div class="pusher">
		<div class="ui container fluid">
			<div class="ui stackable menu" style="border-radius:0">
				<div class="item">
					<div class="ui breadcrumb">
						...
						<div class="active section">Jurnal Umum</div>
					</div>
				</div>
			</div>
			...
			<div class="ui bottom attached tab segment active" data-tab="first">
				...
				<form  class="ui form form-javascript" id="form_transaction" action="<?php echo base_url() ?>index.php/C_jumum/save" method="post">
				<div class="ui grid">
						...
						<table id="pos_data_tabel" class="ui celled table" cellspacing="0" width="100%" style="margin-top:15px;">
							...
							<tbody id="pos_body">
								<tr id="pos_tr_1">
									...
									<td>
										<select class="form-pos" onkeydown=entToTab("1","1") name="id_account_from_1" id="input_1_1">
									...
									<td>
										<select class="form-pos" onkeydown=entToTab("1","2") name="id_account_to_1" id="input_1_2">
											<option value="">-- Pilih Account --</option>
											<?php foreach($accountumum as $k){ ?>
											<option value="<?php echo $k->accountnumber ?>"><?php echo $k->accountnumber ?> - <?php echo $k->accountname ?></option>
											<?php } ?>
									...
									<td>
										<input class="form-pos" type="text" name="keterangan_1" id="input_1_3" onkeydown=entToTab("1","3") autocomplete="off">
									</td>
									<td>
			...
			<div class="ui bottom attached tab segment" data-tab="second">
				...
				<form class="ui form form-javascript" id="form_filter" action="<?php echo base_url() ?>index.php/C_jumum/filter/" method="post">
				<div class="ui grid">
...
<script>
	...
	function tambahBaris(){
		if(exeTambahBaris == false){
			...
			if(rowData == maxData){
				...
				$.ajax({
					url : webUrl+'/index.php/C_jumum/tambah_baris/'+rowData,
					type: 'post',
					dataType: 'json',
	...
	function valueToCurrency(idRow){
		...
		if (jumlahVal.indexOf('.') > -1){
			...
			document.getElementById("input_"+idRow+"_4").value = beforeComma;
	...
	function exeDeleteTrans(idTrans){
		...
		$.ajax({
			url : webUrl+'/index.php/C_jumum/hapus/'+idTrans,
			type: "GET",
			dataType: "JSON",
			success: function(response){
				if(response.success == true){
