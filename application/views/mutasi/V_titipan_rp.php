	...
	<div class="pusher">
		<div class="ui container fluid">
			<div class="ui stackable menu" style="border-radius:0">
				<div class="item">
					<div class="ui breadcrumb">
						...
						<div class="active section">Titipan Pelanggan (Rupiah)</div>
					</div>
				</div>
			</div>
			...
			<div class="ui bottom attached tab segment active" data-tab="first">
				...
				<form  class="ui form form-javascript" id="form_transaction" action="<?php echo base_url() ?>index.php/C_titipan_rp/save" method="post">
				<div class="ui grid">
			...
			<div class="ui bottom attached tab segment" data-tab="second">
				...
				<form class="ui form form-javascript" id="form_filter" action="<?php echo base_url() ?>index.php/C_titipan_rp/filter/" method="post">
				<div class="ui grid">
...
<script>
	...
	function begBalToCurrency(){
		...
		if (jumlahVal.indexOf('.') > -1){
			...
			document.getElementById("input_data_2").value = beforeComma;
		}else{
			jumlahVal = parseFloat(jumlahVal);
			jumlahVal = jumlahVal.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,');
