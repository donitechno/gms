	...
	<div class="pusher">
		<div class="ui container fluid">
			<div class="ui stackable menu" style="border-radius:0">
				<div class="item">
					<div class="ui breadcrumb">
						...
						<div class="active section">Pesanan Pelanggan</div>
					</div>
				</div>
			</div>
			...
			<div class="ui bottom attached tab segment" data-tab="second">
				...
				<form class="ui form form-javascript" id="form_filter" action="<?php echo base_url() ?>index.php/C_pesanan/filter/" method="post">
				<div class="ui grid">
...
<script>
	...
	function getMasterProductModal(idRow){
		...
		if(categoryID != ''){
			$.ajax({
				url : webUrl+'/index.php/C_pesanan/get_master_product_modal/'+categoryID+'/'+idRow,
				type: "GET",
				dataType: "JSON",
				success: function(response){
					if(response.success == true){
	...
	function getEditPesanan(idPesanan){
		...
		$.ajax({
			url : webUrl+'/index.php/C_pesanan/get_edit_pesanan/'+idPesanan,
			type: "GET",
			dataType: "JSON",
			success: function(response){
				if(response.success == true){
	...
	function getTambahUMP(idPesanan){
		...
		$.ajax({
			url : webUrl+'/index.php/C_pesanan/get_tambah_ump/'+idPesanan,
			type: "GET",
			dataType: "JSON",
			success: function(response){
				if(response.success == true){
	...
	function getKurangUMP(idPesanan){
		...
		$.ajax({
			url : webUrl+'/index.php/C_pesanan/get_kurang_ump/'+idPesanan,
			type: "GET",
			dataType: "JSON",
			success: function(response){
				if(response.success == true){
	...
	function exeBatalPesanan(idPesanan){
		...
		$.ajax({
			url : webUrl+'/index.php/C_pesanan/batal_pesanan/'+idPesanan,
			type: "GET",
			dataType: "JSON",
			success: function(response){
				if(response.success == true){
