...
class C_lap_reparasi extends CI_Controller {
	...
	public function index(){
		$this->load->view('report/V_lap_reparasi');
	}
	...
	public function filter_lap(){
		...
		$data['view'] = '<div class="ui grid"><div class="sixteen wide centered column" style="text-align:right"><a class="ui facebook button" href="'.base_url().'index.php/C_lap_reparasi/lap_to_pdf/'.$tanggal_transaksi.'" target="_blank"><i class="paperclip icon"></i> Download</a></div></div><table id="filter_data_tabel " class="ui celled table" cellspacing="0" width="100%"><thead><tr style="text-align:center"><th class="center aligned" rowspan="2">Keterangan</th><th class="center aligned" colspan="'.$colspan_head.'">Kelompok Emas</th><th class="center aligned" colspan="3">Hutang/Piutang Emas Bahan</th></tr><tr style="text-align:center">';
	...
	public function lap_to_pdf($tgl_transaksi){
		...
		$data['view'] = '<table class="lap_pdf_4" cellspacing="0" width="100%"><tr><td colspan="2" style="text-align:left; border:none"><img src="'.base_url().'assets/images/branding/brand.png" style="width:280px"></td><td colspan="4" style="text-align:center;font-size:16px;border:none;font-weight:bold">Laporan Emas Reparasi Harian <br>Cabang '.$sitename.'</td><td colspan="3" style="text-align:right;font-size:16px;border:none;font-weight:bold"><br>'.$hari_tulis.', '.$tanggal_aktif.'</td></tr><thead><tr style="text-align:center"><th class="center aligned" rowspan="2" style="width:220px">Keterangan</th><th class="center aligned" colspan="'.$colspan_head.'">Kelompok Emas</th><th class="center aligned" colspan="3">Hutang/Piutang Emas Bahan</th></tr><tr style="text-align:center">';
		...
		$data['view'] .= '<div class="ket-ttd2">Dibuat Oleh : </div><div class="nama-ttd2"><span>Pembukuan Cabang</span></div><div class="ket-ttd2">Diperiksa Oleh : </div><div class="nama-ttd2"><span>Staff Accounting</span></div><div class="ket-ttd2">Disetujui Oleh : </div><div class="nama-ttd2"><span>Manager Cabang</span></div>';
