...
class C_sync extends CI_Controller {
	...
	public function index(){
		...
		$dbBackup->connect("localhost","root","bandabaru","gms_avr");
		$dbBackup->backup();
		//$dbBackup->download();
		$tanggal = date("Ymd");
		$dbBackup->save("C://",$tanggal);
		
		$tgl_to = date("Y-m-d").' 23:59:59';
		$tgl_to2 = date("Y-m-d");
		$tgl_from = date('Y-m-d',strtotime($tgl_to2. "-60 days")).' 00:00:00';
		...
		$last_id_titipan_gr = $this->ms->get_last_id_titipan_gr($dbsite);
		$last_id_titipan_gr = $last_id_titipan_gr[0]->created_date;
		$data_titipan_gr = $this->ms->get_all_titipan_gr($last_id_titipan_gr);
		foreach($data_titipan_gr as $d){
			$this->ms->insert_titipan_gr($dbsite,$d->id,$d->nama_pelanggan,$d->created_date,$d->created_by);
		}
		
		$last_id_titipan_rp = $this->ms->get_last_id_titipan_rp($dbsite);
		$last_id_titipan_rp = $last_id_titipan_rp[0]->created_date;
		$data_titipan_rp = $this->ms->get_all_titipan_rp($last_id_titipan_rp);
		...
		$last_id_product_update = $this->ms->get_last_id_product_update($dbsite);
		$last_id_product_update = $last_id_product_update[0]->last_updated;
		$data_product = $this->ms->get_data_product($last_id_product_update);
		...
		$last_id_main_beli = $this->ms->get_last_id_main_beli($dbsite);
		$last_id_main_beli = $last_id_main_beli[0]->id;
		$data_main_beli = $this->ms->get_main_pembelian($last_id_main_beli);
		...
		$last_id_detail_beli = $this->ms->get_last_id_detail_beli($dbsite);
		$last_id_detail_beli = $last_id_detail_beli[0]->id;
		$data_detail_beli = $this->ms->get_detail_pembelian($last_id_detail_beli);
		...
		$last_id_main_jual = $this->ms->get_last_id_main_jual($dbsite);
		$last_id_main_jual = $last_id_main_jual[0]->id;
		$data_main_jual = $this->ms->get_main_penjualan($last_id_main_jual);
		...
		$last_id_detail_jual = $this->ms->get_last_id_detail_jual($dbsite);
		$last_id_detail_jual = $last_id_detail_jual[0]->id;
		$data_detail_jual = $this->ms->get_detail_penjualan($last_id_detail_jual);
		...
		$last_id_main_pesanan = $this->ms->get_last_id_main_pesanan($dbsite);
		$last_id_main_pesanan = $last_id_main_pesanan[0]->last_updated;
		$data_main_pesanan = $this->ms->get_main_pesanan($last_id_main_pesanan);
		...
		$last_id_detail_pesanan = $this->ms->get_last_id_detail_pesanan($dbsite);
		$last_id_detail_pesanan = $last_id_detail_pesanan[0]->last_updated;
		$data_detail_pesanan = $this->ms->get_detail_pesanan($last_id_detail_pesanan);
		...
		$last_id_mutasi_gr = $this->ms->get_last_id_mutasi_gr($dbsite);
		$last_id_mutasi_gr = $last_id_mutasi_gr[0]->createddate;
		$data_mutasi_gr = $this->ms->get_mutasi_gr($last_id_mutasi_gr);
		...
		$last_id_mutasi_gr_hapus = $this->ms->get_last_id_mutasi_gr_hapus($dbsite);
		$last_id_mutasi_gr_hapus = $last_id_mutasi_gr_hapus[0]->deleteddate;
		$data_mutasi_gr_hapus = $this->ms->get_mutasi_gr_hapus($last_id_mutasi_gr_hapus);
		...
		$last_id_mutasi_rp = $this->ms->get_last_id_mutasi_rp($dbsite);
		$last_id_mutasi_rp = $last_id_mutasi_rp[0]->createddate;
		$data_mutasi_rp = $this->ms->get_mutasi_rp($last_id_mutasi_rp);
		...
		$last_id_mutasi_rp_hapus = $this->ms->get_last_id_mutasi_rp_hapus($dbsite);
		$last_id_mutasi_rp_hapus = $last_id_mutasi_rp_hapus[0]->deleteddate;
		$data_mutasi_rp_hapus = $this->ms->get_mutasi_rp_hapus($last_id_mutasi_rp_hapus);
		...
		$last_id_mutasi_pengadaan = $this->ms->get_last_id_mutasi_pengadaan($dbsite);
		$last_id_mutasi_pengadaan = $last_id_mutasi_pengadaan[0]->id;
		$data_mutasi_pengadaan = $this->ms->get_mutasi_pengadaan($last_id_mutasi_pengadaan);
		...
		$last_id_mutasi_pengadaan_hapus = $this->ms->get_last_id_mutasi_pengadaan_hapus($dbsite);
		$last_id_mutasi_pengadaan_hapus = $last_id_mutasi_pengadaan_hapus[0]->id;
		$data_mutasi_pengadaan_hapus = $this->ms->get_mutasi_pengadaan_hapus($last_id_mutasi_pengadaan_hapus);
		...
		$last_id_mutasi_reparasi = $this->ms->get_last_id_mutasi_reparasi($dbsite);
		$last_id_mutasi_reparasi = $last_id_mutasi_reparasi[0]->id;
		$data_mutasi_reparasi = $this->ms->get_mutasi_reparasi($last_id_mutasi_reparasi);
		...
		$last_id_mutasi_reparasi_hapus = $this->ms->get_last_id_mutasi_reparasi_hapus($dbsite);
		$last_id_mutasi_reparasi_hapus = $last_id_mutasi_reparasi_hapus[0]->id;
		$data_mutasi_reparasi_hapus = $this->ms->get_mutasi_reparasi_hapus($last_id_mutasi_reparasi_hapus);
		...
		$last_id_mutasi_titip_pgd = $this->ms->get_last_id_mutasi_titip_pgd($dbsite);
		if(count($last_id_mutasi_titip_pgd) == 0){
			$last_id_mutasi_titip_pgd = 1;
		}else{
			$last_id_mutasi_titip_pgd = $last_id_mutasi_titip_pgd[0]->id;
		}
		
		$data_mutasi_titip_pgd = $this->ms->get_mutasi_titip_pgd($last_id_mutasi_titip_pgd);
		...
		$last_id_mutasi_titip_pgd_hapus = $this->ms->get_last_id_mutasi_titip_pgd_hapus($dbsite);
		if(count($last_id_mutasi_titip_pgd_hapus) == 0){
			$last_id_mutasi_titip_pgd_hapus = 1;
		}else{
			$last_id_mutasi_titip_pgd_hapus = $last_id_mutasi_titip_pgd_hapus[0]->id;
		}
		
		$data_mutasi_titip_pgd_hapus = $this->ms->get_mutasi_titip_pgd_hapus($last_id_mutasi_titip_pgd_hapus);
		...
		$last_id_pindah_box = $this->ms->get_last_id_pindah_box($dbsite);
		$last_id_pindah_box = $last_id_pindah_box[0]->created_date;
		$data_pindah_box = $this->ms->get_pindah_box($last_id_pindah_box);
		...
		$last_id_stock_in = $this->ms->get_last_id_stock_in($dbsite);
		$last_id_stock_in = $last_id_stock_in[0]->created_date;
		$data_stock_in = $this->ms->get_stock_in($last_id_stock_in);
		...
		$last_id_stock_out = $this->ms->get_last_id_stock_out($dbsite);
		$last_id_stock_out = $last_id_stock_out[0]->created_date;
		$data_stock_out = $this->ms->get_stock_out($last_id_stock_out);
		...
		$last_id_detail_trans_cabang = $this->ms->get_last_id_detail_trans_cabang($dbsite);
		$last_id_detail_trans_cabang = $last_id_detail_trans_cabang[0]->id;
		$data_trans_cabang = $this->ms->get_detail_trans_cabang($last_id_detail_trans_cabang);
