...
class BestCS extends CI_Controller {
	...
	public function filter(){
		...
		$customer = array();
		foreach($data_best as $db){
			$customer[$db->cust_service] = 0;
		}
