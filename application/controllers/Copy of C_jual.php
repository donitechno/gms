...
class C_jual extends CI_Controller {	
	...
	public function save_jual($row_number,$print_flag){
		...
		if($print_flag == 'P'){
			...
			$connector = new Escpos\PrintConnectors\WindowsPrintConnector("smb://Guest@".$computer_name."/".$printer_name);
	...
	private function validate_jual(){
		$data = array();
